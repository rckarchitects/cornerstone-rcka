...
echo "<a href=\"index2.php?page=tasklist_project&amp;proj_id=$proj_id\" class=\"submenu_bar\">Oustanding Tasks</a>";
} else {
echo "<a href=\"index2.php?page=tasklist_project&amp;view=complete&amp;proj_id=$proj_id\" class=\"submenu_bar\">Completed Tasks</a>";	
}
...
$tasklist_due = $array['tasklist_due'];
					...
					if ($proj_id != $proj_id_repeat) {
					   		echo "<h2>";
							if ($proj_fee_track == "1") {
							echo "<a href=\"index2.php?page=project_view&amp;proj_id=$proj_id\" name=\"view_task_$proj_id\">$proj_num&nbsp;$proj_name</a>";
							} else {
							echo $proj_num."&nbsp;".$proj_name;
							}
